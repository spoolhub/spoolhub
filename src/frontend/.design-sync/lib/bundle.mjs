// forked from design-sync lib/bundle.mjs — add tsconfig option for @/ path alias + local-css loader for CSS Modules
...
export async function bundleToIife({ entry, globalName, nodePaths, out, tsconfig, externals = [] }) {
  ...
  try {
    buildResult = await build({
      ...
      logLevel: 'warning',
      minify: false,
      banner: { js: 'var __import_meta_env__={"VITE_API_URL":"","DEV":true,"PROD":false,"SSR":false,"MODE":"development"};' },
      define: {
