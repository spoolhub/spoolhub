...
export default function SpoolCard({ spool, onClick }: SpoolCardProps) {
  ...
  const createdAt = new Date(spool.createdAt).toLocaleString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })
        ...
        <div className={styles.info}>
          <div className={styles.nameRow}>
            ...
            <div className={styles.badges}>
              ...
              {spool.hasNfcTag && (
                <svg aria-label={t('spools.nfcTagLinked')} width="20" height="20" className={styles.nfcIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className={styles.tags}>
            <span className={styles.materialBadge}>
              <svg width="12" height="12" className={styles.iconFlexShrink} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
