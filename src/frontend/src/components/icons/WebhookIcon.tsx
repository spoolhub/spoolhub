import styles from './WebhookIcon.module.css'
interface IconProps {
  size?: number
  className?: string
}
...
export default function WebhookIcon({ size = 24, className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={[styles.icon, className].filter(Boolean).join(' ')} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
